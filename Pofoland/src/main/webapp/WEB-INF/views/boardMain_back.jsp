        ...
        <div class="row">
            <div class="col-md-9">
                <div class="single-blog">
                    <article>
                        <div class="post-thumb"><img class="img-responsive" src="${contextPath}/resources/assets/images/blog/01.jpg" alt=""></div>
                            ...
                            <div id="post-carousel" class="carousel slide" data-ride="carousel">            
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <img src="${contextPath}/resources/assets/images/blog/01.jpg" alt="">
                                    </div>
                                    <div class="item">
                                        <img src="${contextPath}/resources/assets/images/blog/02.jpg" alt="">           
                                    </div>
                                    <div class="item">
                                        <img src="${contextPath}/resources/assets/images/blog/03.jpg" alt="">           
                                    </div>
