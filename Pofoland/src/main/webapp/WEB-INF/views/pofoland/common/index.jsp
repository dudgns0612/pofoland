    ...
    <section id="slider">
        <div id="home-carousel" class="carousel slide" data-ride="carousel">            
            <div class="carousel-inner">
                <div class="item active" style="background-image: url(${contextPath}/resources/assets/images/slider/01.jpg)">
                    ...
                    <div class="portfolio-items">
                        ...
                        <div class="col-md-4 col-sm-6 work-grid wordpress graphic">
                            <div class="portfolio-content">
                                ...
                                <div class="portfolio-overlay">
                                    <a href="${contextPath}/resources/assets/images/works/portfolio-1.jpg"><i class="fa fa-camera-retro"></i></a>
                        ...
                        <div class="col-md-4 col-sm-6 work-grid html php bootstrap">
                            <div class="portfolio-content">
                                ...
                                <div class="portfolio-overlay">
                                    <a href="${contextPath}/resources/assets/images/works/portfolio-2.jpg"><i class="fa fa-camera-retro"></i></a>
                                    <h5>Web Development</h5>
                                    <p>Design, Develop</p>
                                </div>
                            </div>  
                        ...
                        <div class="col-md-4 col-sm-6 work-grid wordpress graphic">
                            <div class="portfolio-content">
                                ...
                                <div class="portfolio-overlay">
                                    <a href="${contextPath}/resources/assets/images/works/portfolio-3.jpg"><i class="fa fa-camera-retro"></i></a>
                                    <h5>Web Development</h5>
                                    <p>Design, Develop</p>
                                </div>
                            </div>  
                        ...
                        <div class="col-md-4 col-sm-6 work-grid html php bootstrap">
                            <div class="portfolio-content">
                                ...
                                <div class="portfolio-overlay">
                                    <a href="${contextPath}/resources/assets/images/works/portfolio-4.jpg"><i class="fa fa-camera-retro"></i></a>
                                    <h5>Web Development</h5>
                                    <p>Design, Develop</p>
                                </div>
                            </div>  
                        ...
                        <div class="col-md-4 col-sm-6 work-grid wordpress graphic php">
                            <div class="portfolio-content">
                                ...
                                <div class="portfolio-overlay">
                                    <a href="${contextPath}/resources/assets/images/works/portfolio-5.jpg"><i class="fa fa-camera-retro"></i></a>
                                    <h5>Web Development</h5>
                                    <p>Design, Develop</p>
                                </div>
                            </div>  
                        ...
                        <div class="col-md-4 col-sm-6 work-grid html bootstrap graphic">
                            <div class="portfolio-content">
                                ...
                                <div class="portfolio-overlay">
                                    <a href="${contextPath}/resources/assets/images/works/portfolio-6.jpg"><i class="fa fa-camera-retro"></i></a>
                                    <h5>Web Development</h5>
                                    <p>Design, Develop</p>
                                </div>
                            </div>  
