			...
			<div class="col-md-12">
				<div class="bottom">
					<div style="margin-top:100px;">
						...
						<input id="modifyCencleBtn" class="btn btn-warning" type="button" onclick="location.href='${contextPath}/user/modify'" value="수정취소" style="width: 24.50%; height: 40px;" />
						<input id="modifyPwBtn" class="btn btn-warning" type="button" onclick="location.href='${contextPath}/user/modify'" value="비밀번호 수정" style="width: 24.50%; height: 40px;" />
						<input id="userDeleteBtn" class="btn btn-warning" type="button" onclick="location.href='${contexPath}/user/logout'" value="회원탈퇴" style="width: 24.50%; height: 40px;" />
					</div>
				</div>
			</div>
		</div>
