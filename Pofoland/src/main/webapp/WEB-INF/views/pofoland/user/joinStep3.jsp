	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="col-xs-8 text-center">
				<img src="${contextPath}/resources/custom/images/user/joinStep3.png"
				...
				<form id="step3Form" class="form-horizontal" method="POST">
					...
					<fieldset>
						...
						<!-- 패스워드 확인폼 -->
						<div class="form-group has-feedback">
							<label class="col-md-3 control-label" for="inputPw"> <img
								src="${contextPath}/resources/custom/images/user/checking.png" />
							</label>
							<div class="col-md-6 inputGroupContainer">
