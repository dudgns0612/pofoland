...
<input type="hidden" id="userSeq" value=<c:if test="${userSeq != '' && userSeq != null}">"${userSeq}"</c:if> />
<input type="hidden" id="userId" value=<c:if test="${userId != '' && userId != null}">"${userId}"</c:if> />
